...
const createBithumbAnnouncementService = (): AnnouncementService => {
  const id: ExchangeId = 'bithumb';
...
export const bithumbAnnouncementService = createBithumbAnnouncementService();