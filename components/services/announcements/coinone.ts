...
const createCoinoneAnnouncementService = (): AnnouncementService => {
  const id: ExchangeId = 'coinone';
...
export const coinoneAnnouncementService = createCoinoneAnnouncementService();